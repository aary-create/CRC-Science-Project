...
const en = {
  ...
  mapsMissing: "Location search needs a map connection that isn't set up yet — type your area name instead.",
  ...
  hospitalsNote: "Live from Google Maps, nearest first.",
  ...
  communityNote: "Posted by people nearby. Not checked by any agency.",
  nothing: "Nothing here right now.",
  loadFail: "Could not load the feed. Check your connection and reopen this page.",
  reportTitle: "Report what you see",
  reportPlace: "Place",
  reportPlacePlaceholder: "Which locality?",
  reportHazard: "Type",
  reportText: "What is happening?",
  reportSend: "Post report",
  reportSent: "Report posted.",
  reportFail: "Could not post. Check your connection and try again.",
...
const dict: Record<Exclude<Lang, "en">, Partial<Record<Key, string>>> = {
  hi: {
    ...
    loading: "लोड हो रहा है…", editProfile: "बदलें", connected: "जुड़ा है", cached: "सहेजा हुआ", noConnection: "इंटरनेट नहीं है",
    ...
    helpTitle: "नज़दीकी मदद", hospitalsNote: "गूगल मैप्स से लाइव, सबसे नज़दीक पहले।",
    ...
    helplines: "राष्ट्रीय हेल्पलाइन", youAreHere: "आप यहाँ हैं", feedTitle: "फ़ीड", official: "आधिकारिक",
    community: "लोगों की रिपोर्ट", communityNote: "आस-पास के लोगों द्वारा भेजी गई। किसी एजेंसी ने जाँच नहीं की।",
    nothing: "अभी यहाँ कुछ नहीं है।", loadFail: "फ़ीड लोड नहीं हुई। इंटरनेट जाँचें और पेज दोबारा खोलें।",
    unverifiedTag: "असत्यापित", offlineTitle: "ऑफ़लाइन", offlineNote: "ऑफ़लाइन डेटा दिख रहा है।",
    ...
    historyTitle: "चेतावनी इतिहास", historyNote: "इस डिवाइस पर 5 दिन तक रखा जाता है, फिर अपने आप हट जाता है।", noHistory: "अभी तक कुछ दर्ज नहीं हुआ।",
    nav_alert: "अलर्ट", nav_help: "मदद", nav_feed: "फ़ीड", nav_offline: "ऑफ़लाइन",
  ...
  gu: {
    ...
    loading: "લોડ થઈ રહ્યું છે…", editProfile: "બદલો", connected: "જોડાયેલ", cached: "સાચવેલું", noConnection: "ઇન્ટરનેટ નથી",
    ...
    helpTitle: "નજીકની મદદ", hospitalsNote: "ગૂગલ મેપ્સ પરથી લાઇવ, સૌથી નજીકનું પહેલાં.",
    ...
    helplines: "રાષ્ટ્રીય હેલ્પલાઇન", youAreHere: "તમે અહીં છો", feedTitle: "ફીડ", official: "સત્તાવાર",
    community: "લોકોના અહેવાલ", communityNote: "આસપાસના લોકો દ્વારા મોકલાયેલ. કોઈ એજન્સીએ ચકાસ્યું નથી.",
    nothing: "હાલમાં અહીં કંઈ નથી.", loadFail: "ફીડ લોડ ન થઈ. ઇન્ટરનેટ તપાસો અને પેજ ફરી ખોલો.",
    unverifiedTag: "ચકાસાયેલ નથી", offlineTitle: "ઑફલાઇન", offlineNote: "ઑફલાઇન ડેટા બતાવી રહ્યા છીએ.",
    ...
    historyTitle: "ચેતવણી ઇતિહાસ", historyNote: "આ ડિવાઇસ પર 5 દિવસ સુધી રખાય છે, પછી આપોઆપ કાઢી નખાય છે.", noHistory: "હજી કંઈ નોંધાયું નથી.",
    nav_alert: "ચેતવણી", nav_help: "મદદ", nav_feed: "ફીડ", nav_offline: "ઑફલાઇન",
  ...
  ta: {
    ...
    loading: "ஏற்றுகிறது…", editProfile: "மாற்று", connected: "இணைக்கப்பட்டது", cached: "சேமிக்கப்பட்டது", noConnection: "இணைய இணைப்பு இல்லை",
    ...
    helpTitle: "அருகிலுள்ள உதவி", hospitalsNote: "கூகிள் மேப்ஸிலிருந்து நேரடி, அருகிலுள்ளது முதலில்.",
    ...
    helplines: "தேசிய உதவி எண்கள்", youAreHere: "நீங்கள் இங்கே", feedTitle: "செய்திகள்", official: "அதிகாரப்பூர்வம்",
    community: "மக்களின் தகவல்கள்", communityNote: "அருகிலுள்ளவர்களால் அனுப்பப்பட்டது. எந்த நிறுவனமும் சரிபார்க்கவில்லை.",
    nothing: "இப்போது இங்கு எதுவும் இல்லை.", loadFail: "தகவலை ஏற்ற முடியவில்லை. இணையத்தைச் சரிபார்த்து பக்கத்தை மீண்டும் திறக்கவும்.",
    unverifiedTag: "சரிபார்க்கப்படாதது", offlineTitle: "ஆஃப்லைன்", offlineNote: "ஆஃப்லைன் தரவு காட்டப்படுகிறது.",
    ...
    historyTitle: "எச்சரிக்கை வரலாறு", historyNote: "இந்தச் சாதனத்தில் 5 நாட்கள் வைக்கப்பட்டு, பின் தானாக நீக்கப்படும்.", noHistory: "இதுவரை எதுவும் பதிவு செய்யப்படவில்லை.",
    nav_alert: "எச்சரிக்கை", nav_help: "உதவி", nav_feed: "செய்திகள்", nav_offline: "ஆஃப்லைன்",
  ...
  as: {
    ...
    loading: "লোড হৈ আছে…", editProfile: "সলনি কৰক", connected: "সংযুক্ত", cached: "সংৰক্ষিত", noConnection: "ইণ্টাৰনেট নাই",
    ...
    helpTitle: "ওচৰৰ সহায়", hospitalsNote: "গুগল মেপৰ পৰা লাইভ, আটাইতকৈ ওচৰৰটো প্ৰথমে।",
    ...
    helplines: "ৰাষ্ট্ৰীয় হেল্পলাইন", youAreHere: "আপুনি ইয়াত আছে", feedTitle: "ফিড", official: "চৰকাৰী",
    community: "ৰাইজৰ খবৰ", communityNote: "ওচৰৰ মানুহে পঠোৱা। কোনো সংস্থাই পৰীক্ষা কৰা নাই।",
    nothing: "এই মুহূৰ্তত ইয়াত একো নাই।", loadFail: "ফিড লোড নহ'ল। ইণ্টাৰনেট পৰীক্ষা কৰি পৃষ্ঠাটো পুনৰ খোলক।",
    unverifiedTag: "অপ্ৰমাণিত", offlineTitle: "অফলাইন", offlineNote: "অফলাইন তথ্য দেখুৱাই আছে।",
    ...
    historyTitle: "সতৰ্কবাণীৰ ইতিহাস", historyNote: "এই ডিভাইচত ৫ দিনলৈ ৰখা হয়, তাৰ পিছত নিজে আঁতৰি যায়।", noHistory: "এতিয়ালৈকে একো লিপিবদ্ধ হোৱা নাই।",
    nav_alert: "সতৰ্কবাণী", nav_help: "সহায়", nav_feed: "ফিড", nav_offline: "অফলাইন",
